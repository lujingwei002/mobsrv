...
// optional int32 err = 3 [default = 0];
inline bool REGIST::has_err() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void REGIST::set_has_err() {
  _has_bits_[0] |= 0x00000004u;
}
inline void REGIST::clear_has_err() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void REGIST::clear_err() {
  err_ = 0;
  clear_has_err();
}
inline ::google::protobuf::int32 REGIST::err() const {
  // @@protoc_insertion_point(field_get:account.REGIST.err)
  return err_;
}
inline void REGIST::set_err(::google::protobuf::int32 value) {
  set_has_err();
  err_ = value;
  // @@protoc_insertion_point(field_set:account.REGIST.err)
}
...
inline ::google::protobuf::int32 LOGIN::err() const {
  // @@protoc_insertion_point(field_get:account.LOGIN.err)
  return err_;
}
inline void LOGIN::set_err(::google::protobuf::int32 value) {
  set_has_err();
  err_ = value;
  // @@protoc_insertion_point(field_set:account.LOGIN.err)
}
