...
{
    int8_t val = 0;
    read_buf(sockfd, (char *)&val, sizeof(int8_t));
    return val;
}
...
{
    int16_t val = 0;
    read_buf(sockfd, (char *)&val, sizeof(int16_t));
    return val;
}
...
{
    int32_t val = 0;
    read_buf(sockfd, (char *)&val, sizeof(int32_t));
    return val;
}
...
{
    int8_t val = 0;
    get_buf(sockfd, (char *)&val, sizeof(int8_t));
    return val;
}
...
{
    uint32_t val = 0;
    get_buf(sockfd, (char *)&val, sizeof(uint32_t));
    return val;
}
...
{
    uint16_t val = 0;
    get_buf(sockfd, (char *)&val, sizeof(uint16_t));
    return val;
}
...
{
    int16_t val = 0;
    get_buf(sockfd, (char *)&val, sizeof(int16_t));
    return val;
}
...
{
    int32_t val = 0;
    get_buf(sockfd, (char *)&val, sizeof(int32_t));
    return val;
}
